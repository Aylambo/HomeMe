...
export class _AddOrder extends React.Component {
    ...
    onSaveOrder = (ev) => {
        ...
        if (this.props.loggedInUser) {
            ...
            // socketService.setup()
            // socketService.emit('chat topic', this.state.order.hostId)
            // console.log('add order', this.state.order.hostId)
            // socketService.on('chat addMsg', this.addMsg)

            // socketService.emit("private message", {
            //     content: this.state.order,
            //     to: this.state.order.hostId,
            //   });
